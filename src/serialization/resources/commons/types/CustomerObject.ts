...
export const CustomerObject: core.serialization.ObjectSchema<serializers.CustomerObject.Raw, LagoApi.CustomerObject> =
    core.serialization.object({
        ...
        lagoUrl: core.serialization.property("lago_url", core.serialization.string().optional()),
        ...
        applicableTimezone: core.serialization.property("applicable_timezone", core.serialization.string().optional()),
        billingConfiguration: core.serialization.property(
            "billing_configuration",
            core.serialization.lazy(async () => (await import("../../..")).BillingConfigurationCustomer).optional()
        ),
    });
...
export declare namespace CustomerObject {
    interface Raw {
        ...
        url?: string | null;
        phone?: string | null;
        lago_url?: string | null;
        legal_name?: string | null;
        legal_number?: string | null;
        currency?: string | null;
        timezone?: string | null;
        applicable_timezone?: string | null;
        billing_configuration?: serializers.BillingConfigurationCustomer.Raw | null;
    }
}
